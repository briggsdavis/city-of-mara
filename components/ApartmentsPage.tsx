  ...
  return (
    <div className="relative min-h-screen bg-white pt-24">
      ...
      <div className="mx-auto mb-40 max-w-7xl px-8 pt-32">
        ...
        <h1 className="mb-12 font-serif text-6xl leading-none tracking-tighter md:text-9xl">
          The Buildings.
        </h1>
            ...
            <div className="mx-auto grid max-w-7xl items-center gap-24 lg:grid-cols-2">
              ...
              >
                <div className="mb-6 flex items-center space-x-4">
                  <span
                    className={`rounded-full border px-4 py-1.5 text-[10px] font-bold tracking-widest uppercase ${b.status === "Available Units" ? "border-green-200 bg-green-50 text-green-600" : "border-neutral-200 bg-neutral-50 text-neutral-400"}`}
                  >
                    {b.status}
                  </span>
                </div>

                <h2 className="mb-8 font-serif text-5xl tracking-tighter md:text-7xl">
                  {b.name}
                </h2>
                ...
                <div className="mb-12">
                  <h4 className="mb-6 text-[10px] font-bold tracking-widest text-neutral-400 uppercase">
                    Core Features
                  </h4>
                ...
                >
                  <span className="border-b border-black/20 pb-2 text-[10px] font-bold tracking-[0.4em] uppercase transition-all group-hover:border-black">
                    Find Apartments
                  </span>
