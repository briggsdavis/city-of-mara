...
const ApartmentDetailPage: React.FC = () => {
  ...
  const gallery = [
    ...
    {
      src: "https://images.unsplash.com/photo-1600566752355-35792bedcfea?q=80&w=2670&auto=format&fit=crop",
    ...
    <div className="min-h-screen bg-white pt-20">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/40 text-center">
          <div className="px-8">
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="mb-6 block text-[10px] font-bold tracking-[0.8em] text-white uppercase"
            >
            ...
            <motion.h1
              ...
              className="font-serif text-6xl leading-none tracking-tighter text-white md:text-8xl"
            >
              {apt.name}
            </motion.h1>
          </div>
      ...
      <section className="border-y border-neutral-100 bg-neutral-50 py-32">
        <div className="mx-auto grid max-w-7xl gap-20 px-8 lg:grid-cols-2">
          <div>
            <h3 className="mb-10 text-[10px] font-bold tracking-[0.4em] text-neutral-400 uppercase">
              Location Features
            </h3>
            <div className="flex flex-wrap gap-4">
              {[
                ...
                <span
                  key={p}
                  className="rounded-full border border-neutral-200 bg-white px-6 py-3 text-[10px] font-bold tracking-widest text-neutral-600 uppercase"
                >
                  {p}
                </span>
              ))}
      ...
      <section className="mx-auto max-w-7xl border-b border-neutral-100 px-8 py-32 text-center">
        <h2 className="mb-12 font-serif text-4xl tracking-tight">
          Interested in this Residence?
        </h2>
        <div className="flex flex-col items-center justify-center gap-6 md:flex-row">
          <button className="flex items-center space-x-4 bg-black px-12 py-6 text-[10px] font-bold tracking-[0.3em] text-white uppercase shadow-xl transition-all hover:bg-neutral-800">
            <Mail className="h-4 w-4" />
            <span>Request Private Meeting</span>
          </button>
          <button className="flex items-center space-x-4 border border-black px-12 py-6 text-[10px] font-bold tracking-[0.3em] uppercase transition-all hover:bg-black hover:text-white">
      ...
      <section className="mx-auto max-w-7xl px-8 py-40">
        <div className="mb-20">
          <span className="mb-4 block text-[10px] font-bold tracking-[0.4em] text-neutral-400 uppercase">
            Gallery
          </span>
