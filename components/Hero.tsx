    ...
    <section className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-[#F5F5F0]">
      <AnimatePresence mode="wait">
        {currentStep === SequenceStep.INITIAL_TEXT && (
          <motion.div
            ...
            className="z-10 flex font-serif text-[6vw] tracking-tighter select-none"
          >
        ...
        {isStepAtLeast(SequenceStep.WELCOME_TEXT) && (
          ...
          >
            <motion.span
              ...
              className="mb-5 block text-[9px] font-medium tracking-[0.5em] uppercase"
            >
            ...
            <motion.h1
              layout
              className="mb-8 font-serif text-4xl leading-[0.9] tracking-tighter md:text-7xl"
            >
              Architecture <br />
              <span className="ml-4 font-light md:ml-10">of Silence</span>
            </motion.h1>
            ...
            <motion.p
              layout
              className="mx-auto mb-10 max-w-xl text-sm leading-relaxed font-light tracking-wide opacity-70 md:text-base"
            >
            ...
            <AnimatePresence>
              {isStepAtLeast(SequenceStep.BUTTONS) && (
                ...
                >
                  <Link
                    to="/apartments"
                    className="inline-block bg-white px-10 py-4 text-[9px] font-bold tracking-[0.2em] text-black uppercase transition-colors hover:bg-neutral-200"
                  >
                    Explore Residences
                  </Link>
                  <Link
                    to="/about"
                    className="inline-block border border-white/30 px-10 py-4 text-[9px] font-bold tracking-[0.2em] text-white uppercase backdrop-blur-md transition-colors hover:bg-white/10"
                  >
                    Our Philosophy
                  </Link>
                </motion.div>
      ...
      <AnimatePresence>
        {isStepAtLeast(SequenceStep.READY) && (
          ...
          >
            <span className="mb-4 text-[7px] tracking-[0.8em] uppercase">
              Descend
            </span>
