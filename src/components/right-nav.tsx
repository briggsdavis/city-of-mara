  ...
  return (
    <div className="fixed top-1/2 right-8 z-[80] hidden -translate-y-1/2 flex-col items-end space-y-6 xl:flex">
      {dots.map((dot) => (
        ...
        >
          <span
            className={`translate-x-4 text-[8px] font-bold text-black uppercase opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100`}
          >
            {dot.label}
          </span>
