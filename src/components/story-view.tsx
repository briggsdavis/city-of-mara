...
const StoryView: React.FC = () => {
  ...
  return (
    <motion.div className="fixed inset-0 z-[100] overflow-y-auto bg-white">
      ...
      >
        <div className="font-serif text-2xl font-semibold">City of Mara</div>
        <Link
          to="/"
      ...
      <div className="flex min-h-screen flex-col md:flex-row">
        ...
        <div className="min-h-screen w-full bg-white px-8 py-24 md:w-1/2 md:px-24 md:py-48">
          ...
          >
            ...
            <h1 className="mb-16 font-serif text-6xl leading-tight md:text-8xl">
              Legacy in <br />
              the Light.
            </h1>
            ...
            >
              <div className="flex items-center space-x-16">
                <div>
                  <h4 className="mb-3 text-[10px] font-bold uppercase">
                    Architect
                  </h4>
            ...
            <Link
              to="/"
              className="mt-24 inline-block bg-black px-14 py-6 text-[10px] font-bold text-white uppercase transition-colors hover:bg-neutral-800"
            >
              Return to Gallery
            </Link>
          </motion.div>
