...
const valuesData = [
  {
    ...
    img: "/images/about/craftsmanship.jpg",
  },
  {
    title: "Innovation",
...
const AboutPage: React.FC = () => {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    setActiveValue(
      Math.min(Math.floor(latest * valuesData.length), valuesData.length - 1),
    )
  })
    ...
    <div ref={containerRef} className="relative bg-[#F5F5F0]">
      ...
      <div className="fixed top-1/2 right-8 z-[80] hidden -translate-y-1/2 flex-col items-end space-y-6 xl:flex">
        {sections.map((s) => (
          ...
          >
            <span className="translate-x-4 text-[8px] font-bold text-black uppercase opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100">
              {s.label}
            </span>
      ...
      <section id="hero" className="relative h-[90vh] overflow-hidden">
        <motion.div style={{ scale: heroScale }} className="absolute inset-0">
          <img
            src="/images/interiors/open-office-interior.jpg"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-8 text-center text-white">
          <motion.span
            ...
            className="mb-8 block text-[12px] font-bold uppercase"
          >
            Our Origin Story
          </motion.span>
          <motion.h1
            ...
            className="font-serif text-7xl leading-none md:text-9xl"
          >
            Built for <br />
            Decades.
          </motion.h1>
      ...
      >
        ...
        >
          <span className="mb-12 block text-[12px] font-bold text-neutral-400 uppercase">
            The Philosophy
          </span>
          ...
          <div className="relative ml-4 border-l border-black/10 py-20 md:ml-0 md:pl-20">
            {timelineData.map((item, i) => (
              ...
              >
                ...
                <h4 className="mb-6 text-2xl font-bold uppercase">
                  {item.title}
                </h4>
          ...
          <div className="flex h-full w-full">
            <div className="relative h-full w-1/2 overflow-hidden">
              {valuesData.map((val, i) => (
                <motion.div
                  key={i}
                  animate={{ opacity: i === activeValue ? 1 : 0 }}
            ...
            <div className="flex h-full w-1/2 items-center justify-center bg-[#F9F9F7] p-20">
              <div className="relative h-64 w-full max-w-lg">
                {valuesData.map((val, i) => (
                  ...
                  >
                    <span className="mb-6 block text-[12px] font-bold text-neutral-400 uppercase">
                      Value / 0{i + 1}
                    </span>
                    <h3 className="mb-8 font-serif text-6xl">{val.title}</h3>
      ...
      >
        <div className="mx-auto grid max-w-7xl items-center gap-24 lg:grid-cols-2">
          ...
          >
            <span className="mb-10 block text-[12px] font-bold text-neutral-500 uppercase">
              Impact & Philanthropy
            </span>
            <h2 className="mb-12 font-serif text-6xl md:text-8xl">
              The Alber <br />
              Foundation.
            </h2>
            ...
            <div className="mt-20 grid grid-cols-2 gap-12 border-t border-neutral-200 pt-16">
              <div>
                <h4 className="mb-4 text-[10px] font-bold text-neutral-400 uppercase">
          ...
          >
            ...
            <div className="absolute right-12 bottom-12 left-12 text-black">
              <p className="mb-3 text-[10px] font-bold uppercase opacity-60">
                Legacy Project
              </p>
