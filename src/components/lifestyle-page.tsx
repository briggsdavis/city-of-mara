  ...
  const categories = [
    {
      ...
      img: "/images/lifestyle/dining.jpg",
    },
    {
      id: "parks",
    ...
    },
    {
      ...
      img: "/images/lifestyle/shopping.jpg",
    },
    {
      id: "education",
      ...
      img: "/images/lifestyle/education.jpg",
    },
    {
      id: "transit",
    ...
    <div className="min-h-screen bg-white">
      <section className="relative flex h-screen flex-col justify-end">
        <div className="absolute inset-0 z-0">
          <img
            src="/images/lifestyle/city-aerial.jpg"
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-8 pb-32">
          ...
          >
            <span className="mb-8 block text-[12px] font-bold text-white/60 uppercase">
              The District / Timișoara
            </span>
            <h1 className="mb-12 font-serif text-6xl leading-tight text-white md:text-9xl">
              The Pulse <br />
              of Presence.
            </h1>
            ...
            <div className="flex flex-wrap gap-8">
              <Link
                to="/apartments"
                className="bg-white px-12 py-6 text-[10px] font-bold text-black uppercase shadow-2xl transition-all hover:bg-neutral-200"
              >
                View Available Homes
              </Link>
              <button className="border border-white px-12 py-6 text-[10px] font-bold text-white uppercase transition-all hover:bg-white hover:text-black">
          ...
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-8">
            {stats.map((s) => (
              <div key={s.label} className="flex flex-col">
                ...
                <span className="mt-1 text-[9px] font-bold text-white/40 uppercase">
                  {s.label}
                </span>
              </div>
            ))}
      ...
      <section className="mx-auto grid max-w-7xl items-start gap-24 px-8 py-40 md:grid-cols-2">
        ...
        >
          ...
          <h2 className="mb-12 font-serif text-5xl leading-tight">
      ...
      <section className="border-y border-neutral-100 bg-neutral-50 px-8 py-40">
        <div className="mx-auto max-w-7xl">
          <div className="mb-24">
            <h2 className="mb-4 font-serif text-5xl">Life Unfolds Here.</h2>
      ...
      <section className="mx-auto max-w-7xl px-8 py-40">
        <div className="grid items-center gap-32 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-12 text-[9px] font-bold text-neutral-300 uppercase">
      ...
      <section className="mx-auto max-w-4xl px-8 py-40">
        <div className="mb-24 text-center">
          <h2 className="font-serif text-5xl">Expert Inquiries.</h2>
          <p className="mt-4 text-[10px] font-bold text-neutral-400 uppercase">
      ...
      <section className="border-t border-neutral-100 px-8 py-40 text-center">
        ...
        <div className="flex flex-col justify-center gap-6 md:flex-row">
          <Link
            to="/apartments"
            className="bg-black px-16 py-7 text-[10px] font-bold text-white uppercase transition-all hover:bg-neutral-800"
          >
            Explore Available Floorplans
          </Link>
          <Link
            to="/contact"
            className="border border-black px-16 py-7 text-[10px] font-bold uppercase transition-all hover:bg-black hover:text-white"
          >
            Inquire Privately
          </Link>
        </div>
